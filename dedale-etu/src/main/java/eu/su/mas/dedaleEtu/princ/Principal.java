...
import eu.su.mas.dedaleEtu.mas.mesAgents.DummyWumpusShift;
import eu.su.mas.dedaleEtu.mas.mesAgents.DummyWumpusShift2;
...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		ag=createNewDedaleAgent(c, agentName, AgentExplo.class.getName(), entityParametersExplo1);
		agentList.add(ag);
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentExplo.class.getName(), entityParametersExplo2);
		agentList.add(ag);
		***/
...
//
//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollect.class.getName(), entityParametersC);
		agentList.add(ag);
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollect.class.getName(), entityParametersC2);
		agentList.add(ag);
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollect.class.getName(), entityParametersC3);
		agentList.add(ag);
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollect.class.getName(), entityParametersC4);
		agentList.add(ag);
